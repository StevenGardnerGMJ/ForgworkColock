...
class HHLaunchAdPageHUD: UIView {
    ...
    fileprivate var adFrame: CGRect!  /**< 广告图片frame */
    fileprivate var aDduration: Int = 0 /**< 广告停留时间 */
    fileprivate var aDImageUrl: String = "" /**< 广告图片的URL */
    fileprivate var aDhideSkipButton: Bool = false /**< 是否影藏'倒计时/跳过'按钮 */
    fileprivate var launchImageView: UIImageView!  /**< APP启动图片 */
    fileprivate var adImageView: UIImageView!       /**< APP广告图片 */
    fileprivate var skipButton: UIButton! /**< 跳过按钮 */
...
extension HHLaunchAdPageHUD {
    ...
    func dispath_timer() {
        ...
        timer.scheduleRepeating(wallDeadline: .now(), interval: 1)
